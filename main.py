...
random_messages = [
  ...
  "इतना शोर करोगे तो कोई गंभीरता से नहीं लेगा।",
   "का हो, घंटी समझ रखे हो क्या हमको?",
  "इतना पिंग करोगे तो हम भी रूठ जाएंगे भाई!",
  "काहे जान खा रहे हो यार?",
  "लगता है उँगली कीबोर्ड पे चिपक गई है!",
  "का जरूरत है इतना उछलने की?",
  "इतना पिंग करके क्या हासिल होगा बताओ जरा?",
  "हम कोई जादूगर हैं जो तुरंत प्रकट हो जाएं?",
  "का हो, चैन से जीने दोगे कि नहीं?",
  "अरे रुक जाओ, हम भाग थोड़ी रहे हैं!",
  "इतना पिंग करके हीरो नहीं बन जाओगे!",
  "का कर रहे हो यार, कीबोर्ड पे गुस्सा निकाल रहे हो क्या?",
  "का हो, पूरा दिन यही करोगे क्या?",
  "हम म्यूट कर देंगे सही बता रहे है",
  "बौट समझ कर परेशान कर रहे हो न? दुष्ट पापी!",
  "इतना परेशान मत करो, मैं भी इंसान की तरह एक प्रकार का बौट ही हूँ।"
]
...
WELCOME_LOG          = 1499690486238285916
