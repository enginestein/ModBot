...
random_messages = [
  ...
  "काहे पिंग देत हौ बे, जान के दुश्मन बनय चाहत हउवा का?",
    "ए लल्ला, ज्यादा उछल मत, नाहीं त चप्पल से तौल दूँ!",
    "बाउजी के डर से बच गइल रहे, अब हमरे पाले मं आ गय हउवा!",
    "अब्बे चुप रह, नाहीं त अगली बार मुंह तोड़ब!",
    "कबहूं सोचे हउवा का, पिंग देके का होई? फ्री मं जुतई होई!",
    "हमरे सामने पिंग करता हउवा? हिम्मत देख तोहरे!",
    "ओए ससुरा, चुपचाप बैठ जा नाहीं त झाड़ू लेके आ जाइब!",
    "पिंग दिया ना? अब देख डरावना सपना रोज!",
    "बड़ा शेर बनत हउवा? चल जरा बाहर बतावत हईं!",
    "हमार नाम सुन के गाम मं बच्चे रोअत हैं, तू पिंग कर रहा हउवा!",
    "अरे ओ कचरा, पिंग के बदले थप्पड़ चाही का?",
    "पिंग देत हउवा? अब खैर नाहीं तोहार!",
    "हम गुंडा हईं, पिंग के जवाब हम हाथ से देत हईं!",
    "तू पिंग किया... अब पछताएगा बिट्टू!",
    "हमके पिंग किया? अरे जान से हाथ धो बैठब!",
    "बेवकूफी के भी हद होत है, तू ओह पार पहुंच गय हउवा!",
    "अब्बे पिंग मत दे, नाहीं त थप्पड़ मं तारें दिखे लगिहैं!",
    "हमको पिंग करब? तू तो पिटाई मांग रहा हउवा!",
    "ओ ससुर, पिंग से बात ना बनई, सीधे आ मुकाबला कर!",
]
...
async def on_message(message):
    ...
    if bot.user.mentioned_in(message):
        ...
        if message.author.id == SPECIAL_USER_ID:
            special_message1 = random.choice(special_messages)
            await message.channel.send(special_message1)
        elif message.author.id == SECONDARY_SPECIAL_USER_ID:
            special_message2 = random.choice(secondary_messages)
            await message.channel.send(special_message2)
        elif message.author.id == TERTIARY_SPECIAL_USER_ID:
            special_message3 = random.choice(tertiary_messages)
            await message.channel.send(special_message3)
        else:
